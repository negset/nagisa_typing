...
pub fn draw(self: *@This()) void {
    ...
    utils.drawText("時間:", .{ .x = 200, .y = 315 }, .left_top, 36, .black);
    utils.drawText(self.time, .{ .x = 600, .y = 315 }, .right_top, 36, .black);
    utils.drawText("速度:", .{ .x = 200, .y = 360 }, .left_top, 36, .black);
    utils.drawText(self.speed, .{ .x = 600, .y = 360 }, .right_top, 36, .black);
